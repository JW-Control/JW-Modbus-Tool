...
.testsRuntime .planHeader{display:flex;align-items:flex-start;justify-content:space-between;gap:14px;flex:0 0 auto;margin-bottom:8px}.testsRuntime .planTitle{display:grid;gap:8px}.testsRuntime .planTitle p{margin:0;color:var(--muted)}.testsRuntime .planActions{display:flex;gap:9px;align-items:center;justify-content:flex-end;flex-wrap:wrap}.testsRuntime .planActions button{min-height:34px}.testsRuntime .planBody,.testsRuntime .execBody{min-height:0;overflow:auto;scrollbar-width:thin;scrollbar-color:#2d87aa #071d30}.testsRuntime table{width:100%;border-collapse:collapse;font-size:.86rem}.testsRuntime th,.testsRuntime td{border-bottom:1px solid #4588a640;padding:6px 8px;text-align:left;vertical-align:middle}.testsRuntime th{color:var(--muted);font-weight:600;background:#ffffff0a;position:sticky;top:0;z-index:1}.testsRuntime input,.testsRuntime select{width:100%;min-height:30px;border:1px solid #2d5c75;border-radius:6px;background:#061a2b;color:var(--text);padding:4px 7px}.testsRuntime input[type=checkbox]{width:18px;min-height:18px;accent-color:#5ce044}.testsRuntime .slaveInput{-moz-appearance:textfield}.testsRuntime .slaveInput::-webkit-inner-spin-button,.testsRuntime .slaveInput::-webkit-outer-spin-button{-webkit-appearance:none;margin:0}
...
<section class="card scenarios"><header><h2>Escenarios</h2></header><div class="scenarioList">${scHtml()}</div><button class="ghost manageScenarios" data-a="manage">Gestionar escenarios ›</button></section>
...
function kpiHtml(pct, ok, bad, done, avg) {
  ...
  return `<article><div class="kpiRing" style="--p:${pct};--ring:var(--green)"><strong>${pct}%</strong><small>Éxito</small></div><div class="kpiText"><span>Tasa de éxito</span><small>Última ejecución: ${ok}/${done || st.steps.length} aprobados</small></div></article>
...
document.addEventListener("click", (e) => {
  ...
  if (n === "manage") msg("Gestor de escenarios pendiente: editar nombre, descripción, color, ícono y pasos del escenario.");
